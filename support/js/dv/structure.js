...
importScripts(d.rf+'rql'+j,d.rf+'faq'+j,d.rf+'um'+j,d.rf+'t&t_p'+j,d.rf+'imp'+j,d.rf+'cnt'+j,d.rf+'t&c_u'+j)
str={//structure
...
lngs={//languages: title & SEND-BOX
  ...
  es:{
    t:'lista de requerimientos_preguntas frecuentes_manual del usuario_plan de prueba & entrenamiento_mejoras_contacto_periodo y sus codiciones de uso',
