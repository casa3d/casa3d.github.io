rp={//🙋 your opinion is important
  ...
  details:{
    fieldset:{
      adaptive:'when it\'s found in another environment (i.e. different web browser, Operating System)',
      perfective:'propose or change an option of page',
      corrective:"page is working but inside it's found any fault or error (and usually it doesn't let work)",
