...
faq=['how to add window to house_press option ➕ and look for it, (remember currently are 6 kind of textures)',
  "how to resize the windo_press option ✋↔ then hover mouse over object's border (in this case window) and if resizing arrows appear then you're done, just drag it",
