...
o={
  ...
  ob3:new T.Object3D,
  sty:'canvas{left:0;top:0_canvas,.opsMenu{position:fixed_.opsMenu{background:rgba(0,0,0,.5);border-radius:4px;',
  ...
  mn:function(i,ch){
    u.ap(o.mn=u.new('div',{className:'opsMenu'}),u.b)
    o.mn.fn=[
      u.f('o.in.click(o.mn.up=1)'),
      u.f('dr.o&&t.s.remove(dr.o)'),
      u.f('dr.o&&dr.o.rotateY(o.π/2)&&(o.mn.on=0)'),//rotate to the left
      u.f('dr.o&&dr.o.rotateY(-o.π/2)')]//rotate to the right
    o.mn.innerHTML='<button>🌄</button><button>✖</button><button>⟲</button><button>⟳</button>'
    ch=o.mn.children
    for(i in ch){
      if(isNaN(i))return
