...
m={
 ...
 f:F('n','return Number(n.toFixed(2))'),
 act:function(){
  m.rKey=m.rKey?(
   m.x=void 0,
   m.ApprX=!1)
  ...
  m.i+=m.i>1?
   ...
   :m.i==1?
    ...
    :a?
     ...
     :-m.i/2,
  m.vl()},
 rt:F('ρκ/*making rotating-key global & calling m.r*/',
  'm.r(m.ρκ=ρκ)'),
 r:function(){
 ...
 z:function(){
  m.ApprN&&(
   ...
   m.ρ(),
   m.xy(zF,xF))},
 k:F('e','return e.which-30'),//or charCode but keyCode thx Firefox
 ...
 init:function(){
  m.π=m.Π/2
  m.十=/firefox/i.test(navigator.userAgent)?(
   m.一=136,
   134)
   :(
   m.一=150,
...
u.d.E({mousemove:function(e){
  if(u.a){var X=m.X=e.pageX,x=m.x
   m.rKey&&(
    c.rotation.y+=X>x?
     -.009
     :X<x?
   ...
   x!=X&&(m.x=X)}},
 keydown:function(e){
  if(u.a&&u.d.activeElement.type!='text'){var k=m.k(e)-7
   scroll(0,0),e.preventDefault(),e.stopPropagation()
