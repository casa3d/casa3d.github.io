dr={
 ...
 sty:F('c',"'.drg'.Σ(c+'url(css/drg.cur),auto}.drgn'+c+'url(css/drgn.cur),auto}.e-rz'+c+'e-resize}.n-rz'+c+'n-resize')"),
  ...
  dr.app&&(dr.xy(e),
   dr.rc(e)&&(
    ...
    dr.drg.app?
     ...
     :(dr.rsz.brdr()?
       h.M.c(dr.rsz.crs)
       :!dr.rsz.app&&h.M.c(dr.drg.crs),
      dr.rsz.app&&(
       dr.rsz.point&&dr.follow(),
       dr.rsz.init(dr.rsz.crs))),
     dr.rsz.point=dr.rst.point))},
 mousedown:"dr.app&&(dr.rsz.crs?dr.rsz.app=!0:(h.M.c('drgn'),dr.drg.o=dr.new,dr.drg.app=!0))",
 mouseup:function(){
  dr.app&&(
   (dr.rsz.app||dr.drg.app)&&(
    ...
    !dr.rsz.brdr()&&h.M.c(dr.drg.crs='drg')))},
 keydown:F('e','dr.app&&(dr.drg.z=e.ctrlKey)'),
 keyup:F('e',
  'dr.app&&(dr.drg.z=!1),'+
  'e.which==77&&dr.act()')})
dr.sty('{cursor:')
